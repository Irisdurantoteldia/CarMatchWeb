            ...
            <ProtectedRoute>
              <MainLayout>
                <Routes>
                  ...
                  <Route
                    path="/edit/driver-unavailability"
                    element={<DriverUnavailability />}
                  />
                  <Route
                    path="/edit/unavailability-list"
                    element={<UnavailabilityList />}
                  />
                  <Route
                    path="/edit/manage-routes"
                    element={<ManageRoutes />}
                  />
                  <Route
                    path="/edit/manage-vehicle"
                    element={<ManageVehicle />}
                  />
                  <Route path="/edit/saved-routes" element={<SavedRoutes />} />
                  <Route
                    path="/edit/travel-preferences"
                    element={<TravelPreferences />}
                  />
                  <Route
                    path="/edit/edit-schedule"
